-- Create Expense Management and Season Management Tables (Fixed Version)
...
-- 3. Member dues table (without generated column)
...
-- Note: Removed the complex unique constraint for member_dues as it might cause issues
