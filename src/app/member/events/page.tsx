...
function MemberEventsContent() {
  ...
  const updateURL = (season: string, format: string) => {
    ...
    const newURL = params.toString() ? `?${params.toString()}` : '/member/events'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <Link href="/member" className="text-2xl font-bold text-green-800">
                ← Member Console
              </Link>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="mb-6">
          ...
          {userProfile && (
            <p className="text-gray-600 mt-1">
              Welcome, {userProfile.firstName}! <span className="font-medium text-green-600">{userProfile.teamName}</span> team.
            </p>
          )}
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <select
                    ...
                    className="px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 min-w-0 flex-1 max-w-xs"
                  >
                          ...
                          <div className="ml-4">
                            <button
                              onClick={() => {
                                ...
                                if (selectedFormat) params.set('format', selectedFormat.id)
                                const queryString = params.toString()
                                router.push(`/member/events/${event.id}${queryString ? `?${queryString}` : ''}`)
                              }}
